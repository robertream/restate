    ...
    pub fn prometheus_label(&self) -> &'static str {
        ...
        match self {
            EntryType::Command(cmd_type) => match cmd_type {
                ...
                CommandType::LinkService => "Command/LinkService",
                CommandType::UnlinkService => "Command/UnlinkService",
                CommandType::CompleteService => "Command/CompleteService",
                CommandType::StartLinked => "Command/StartLinked",
                CommandType::UnlinkInvocation => "Command/UnlinkInvocation",
                CommandType::AttachService => "Command/AttachService",
            },
            EntryType::Notification(notif_type) => match notif_type {
                NotificationType::Completion(completion_type) => match completion_type {
                    ...
                    CompletionType::LinkService => "Completion/LinkService",
                    CompletionType::CompleteService => "Completion/CompleteService",
                    CompletionType::StartLinked => "Completion/StartLinked",
                    CompletionType::UnlinkService => "Completion/UnlinkService",
                    CompletionType::UnlinkInvocation => "Completion/UnlinkInvocation",
                    CompletionType::AttachService => "Completion/AttachService",
                },
