...
> **Status**: Phase 0-1 + Phase 1.5 (SimStorage) shipped. Next up: SimModel oracle + liveness validation.
> **Canonical plans**:
> - [`specs/plan.md`](./specs/plan.md) — completed Phase 0-1 plan
> - [`specs/sim_model_plan.md`](./specs/sim_model_plan.md) — **active** follow-on plan (Tier 1/Tier 2 oracle + liveness)
>
> **Canonical design research** (referenced from the sim_model_plan):
> - [`research/sim_model_complexity_analysis_041026.md`](./research/sim_model_complexity_analysis_041026.md) — why observable-outcome > internal-state-shadow, three-tier model strategy, liveness primitives
> - [`research/dst_vs_tigerbeetle_vopr_review_041026.md`](./research/dst_vs_tigerbeetle_vopr_review_041026.md) — VOPR gap analysis and ranked roadmap
> - [`research/deterministic_simulation_testing_040926.md`](./research/deterministic_simulation_testing_040926.md) — overall DST roadmap
> - [`research/awakeable_signal_loss_issue_4566_040926.md`](./research/awakeable_signal_loss_issue_4566_040926.md) — the bug Tier 1 must catch as its go/no-go gate
