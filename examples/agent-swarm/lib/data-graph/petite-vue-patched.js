...
const q = [],
    ...
    ce = (e, t, n, s) => {
        if (t === "class") e.setAttribute("class", me(e._class ? [e._class, n] : n) || "");
            ...
            if (!n) e.removeAttribute("style");
                ...
                if (s && !N(s))
                    for (const i in s) n[i] == null && le(r, i, "")
            }
    ...
    on = (e, t, n) => {
        ...
        let c, o;
        for (;
            (c = e.nextElementSibling) && (o = null, k(c, "v-else") === "" || (o = k(c, "v-else-if")));) s.removeChild(c), i.push({
            exp: o,
            el: c
        });
...
const Fe = (e, t) => {
        ...
        if (n === 1) {
            ...
            if ((r = k(s, "v-using")) && r !== "") {
                ...
                if (o && typeof o === "object" && !Array.isArray(o)) {
                    const unwrapped = {};
                    const disposes = [];
                    const ctx = { $el: s, $reactive: D };
                    const _cleanup = ["dispose","destroy","close","disconnect","abort","unsubscribe"];
                    const _findCleanup = (v) => { if (!v || typeof v !== "object") return null; for (const m of _cleanup) if (typeof v[m] === "function") return () => v[m](); return null; };
                    const _resolveArray = (a) => {
                        if (a.length === 1 && typeof a[0] === "function") { const d = a[0](ctx); if (typeof d === "function") disposes.push(d); return undefined; }
                        if (a.length === 2 && typeof a[1] === "function") { const inst = typeof a[0] === "function" ? a[0](ctx) : a[0]; disposes.push(() => a[1](inst)); return inst; }
                        return a;
                    };
                    for (const [key, val] of Object.entries(o)) {
                        if (typeof val === "function") {
                            const result = val(ctx);
                            if (Array.isArray(result)) { const v = _resolveArray(result); if (v !== undefined) unwrapped[key] = v; }
                            else { const c = _findCleanup(result); if (c) disposes.push(c); if (result !== undefined) unwrapped[key] = result; }
                        } else if (Array.isArray(val)) {
                            const v = _resolveArray(val); if (v !== undefined) unwrapped[key] = v;
                        } else {
                            const c = _findCleanup(val); if (c) disposes.push(c);
                            unwrapped[key] = val;
                        }
                    }
                    t = Ge(t, unwrapped);
                    for (const d of disposes) t.cleanups.push(d);
                }
            }
    ...
    Je = (e, t, n, s) => {
        let r, i, c;
        if (t = t.replace(pn, (o, l) => ((c || (c = {}))[l] = !0, "")), t[0] === ":") r = ie, i = t.slice(1);
...
export {
    Qe as createApp, V as nextTick, D as reactive
};